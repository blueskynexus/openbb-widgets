...
app = FastAPI(
    title="Hello World", description="Hello World app for OpenBB Workspace", version="0.0.1"
)
...
def get_widgets():
    ...
    return JSONResponse(
        content=json.load((Path(__file__).parent.resolve() / "documents" / "widgets.json").open())
    )
